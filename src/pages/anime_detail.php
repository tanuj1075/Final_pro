...
<div class="container py-4">
  ...
  <div class="card mb-4">
    <div class="row no-gutters">
      <div class="col-md-4">
        <img src="<?php echo htmlspecialchars(resolve_asset_url($anime['poster_url'])); ?>" class="img-fluid" alt="poster">
      </div>
      <div class="col-md-8">
        <div class="card-body">
  ...
  <div class="row">
    <div class="col-md-6 mb-3">
      <div class="card h-100"><div class="card-body">
        ...
        <img src="<?php echo htmlspecialchars(resolve_asset_url($anime['manga_image_url'])); ?>" class="img-fluid" alt="manga image">
