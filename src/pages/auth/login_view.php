...
define('DB_NAME', 'your_database');   // ← change to your database name
define('DB_USER', 'your_username');   // ← change to your database user
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!isset($_POST['csrf_token']) || !verify_csrf_token($_POST['csrf_token'])) {
        ...
        if (empty($username) || empty($password)) {
            ...
            if ($isEmail) {
                $sql = "SELECT id, username, password_hash FROM users WHERE email = :login";
            } else {
                $sql = "SELECT id, username, password_hash FROM users WHERE username = :login";
            }
