...
$animeList = $db->searchAnime($query, $genre, $status, $sort);
      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card h-100">
          <?php if (!empty($anime['poster_url'])): ?>
            <img src="<?php echo htmlspecialchars($anime['poster_url']); ?>" class="card-img-top" style="height:220px;object-fit:cover" alt="<?php echo htmlspecialchars($anime['title']); ?>">
          <?php endif; ?>
